...
func (c *podVolumeBackupController) RunBackupCommand(cmd *exec.Cmd, req *arkv1api.PodVolumeBackup) (string, string, error) {
	...
	go func() {
		...
		for {
			...
			_, err = c.patchPodVolumeBackup(req, func(r *arkv1api.PodVolumeBackup) {
